...
public class C03_dependsOnMethods {
    ...
    /*
           ...
           Ancak ilk test failed oldugunda, diger method'lar calisip locate etmeyi denedi ve
           10 saniye harcadi

            Bu gorevde oldugu gibi birbirine bagiml, test method'larinda
            bir adim failed oldugunda, sonraki adimlarin passed olma olasiligi bulunmaz
            bu durumda sonraki test method'lari calistirmanın hic bir anlamı olmayacaktir

          1-  Birbirine bagimli olan testleri
            dependsOnMethods="anasayfaTesti" seklinde birbirine baglayabiliriz

            dependsOnMethods ile iki method'u bagladigimizda ilk adim calisip PASSED olmazsa, ikinci adımdaki
            test IGNORE edilir ve calistirilmaz


           2- Bagli iki testden
               ikinci adimi Run etmek istedigimizde
               oncelikle bagimli oldugu ilk adimin calismasini saglar
               İlk adim calisip PASSED olursa ikinci adim calisir
            ...
            3- dependsOnMethods , priority gibi calisma sirasini duzenlemez
               Ancak, calisma sirasi bir method'a geldiiginde o methodun bagli oldugu baska bir method varsa
               oncelikle bagimli oldugunu testin calismasini saglar
